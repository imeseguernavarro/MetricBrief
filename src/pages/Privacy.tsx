...
const sections = [
  {
    ...
    body:
      "InsightHub recopila la informacion necesaria para autenticar usuarios, conectar plataformas sociales y mostrar datos analiticos dentro del panel. Esto puede incluir nombre, correo, imagen de perfil, identificadores de cuenta conectada y metricas autorizadas por el usuario.",
  },
  {
  ...
  },
  {
    ...
    body:
      "InsightHub puede apoyarse en proveedores de infraestructura y autenticacion como Supabase y en integraciones oficiales de terceros como YouTube, TikTok o Instagram, siempre bajo permisos otorgados por el usuario.",
  },
  {
  ...
  },
  {
    title: "Contacto",
    body:
      "Para cuestiones de privacidad, uso de datos o solicitudes de eliminacion, puedes contactar con el equipo de InsightHub a traves de los canales de soporte publicados en la web oficial del servicio.",
  },
];

export function Privacy() {
  return (
    <LegalLayout title="Politica de privacidad" intro="Como InsightHub recopila, usa y protege la informacion asociada a la cuenta y a las plataformas conectadas.">
